...
""" 
    ...
    return:
        counter
""" 
    def blur_e(self,blurr,counter): 
        #blur
        for i in range (0,38):
            manipulated =Image.open('./e/test_'+ str(i) + '.png')
            
            gaussImage = manipulated.filter(ImageFilter.GaussianBlur(blurr))
            for j in range (0,5):
                gaussImage.save('../../dataset/katakana/test/e/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   rotate_image_:
    ...
    return:
        counter
""" 
    def rotate_image_e(self,angle,counter):
        
        for i in range (0,38):
            manipulated =Image.open('./e/test_'+ str(i) + '.png')
            manipulated = manipulated.rotate(angle)
            for j in range (0,50):
                manipulated.save('../../dataset/katakana/test/e/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   zoom_image:
...
""" 
    def shear_e(self,counter):
        for i in range (0,38):
            ...
            plt.axis('off')
            for j in range (0,50):
                plt.imsave('../../dataset/katakana/test/e/picture_'+str(counter) + '.png', sheared_img)
                counter = counter + 1
        return counter
    """
   transpose_90:
    ...
    return:
        counter
""" 
    def transpose_90_e(self,counter): 
        for i in range (0,38):
            manipulated =Image.open('./pictures/test_'+ str(i) + '.png')
            manipulated = manipulated.transpose(Image.ROTATE_90)
            for j in range (0,50):
   ...
   transpose_270:
    ...
    return:
        counter
""" 
    def transpose_270_e(self,counter):
        for i in range (0,38):
            manipulated =Image.open('./pictures/test_'+ str(i) + '.png')
            manipulated = manipulated.transpose(Image.ROTATE_270)
            for j in range (0,50):
