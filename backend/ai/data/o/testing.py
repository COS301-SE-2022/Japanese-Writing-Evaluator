...
""" 
    def blur(self,blurr,counter): 
        ...
        for i in range (0,38):
            ...
            for j in range (0,5):
                gaussImage.save('../../dataset/test/o/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   rotate_image_:
...
""" 
    def rotate_image_(self,angle,counter):
        ...
        for i in range (0,38):
            ...
            for j in range (0,50):
                manipulated.save('../../dataset/test/o/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   zoom_image:
...
""" 
    def shear(self,counter):
        for i in range (0,38):
            ...
            plt.axis('off')
            for j in range (0,50):
                plt.imsave('../../dataset/test/o/picture_'+str(counter) + '.png', sheared_img)
                counter = counter + 1
        return counter
    """
   transpose_90:
