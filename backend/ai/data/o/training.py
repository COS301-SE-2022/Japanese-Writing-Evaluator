...
""" 
    def blur(self,blurr,counter): 
        ...
        for i in range (0,38):
            ...
            for train_o in range (0,100):
                gaussImage.save('../../dataset/train/o/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   rotate_image_:
...
"""   
    def rotate_image_(self,angle,counter):
        ...
        for i in range (0,38):
            ...
            for train_o in range (0,100):
                manipulated.save('../../dataset/train/o/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   zoom_image:
...
""" 
    def shear(self,counter):
        ...
        for i in range (0,38):
            ...
            plt.axis('off')
            for train_o in range (0,100):
                plt.imsave('../../dataset/train/o/picture_'+str(counter) + '.png',sheared_img)
                counter = counter + 1
        return counter
    """
   transpose_90:
