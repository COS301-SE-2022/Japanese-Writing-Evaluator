...
""" 
    def blur(self,blurr,counter): 
        ...
        for i in range (0,38):
            ...
            for blur_train_mo in range (0,100):
                gaussImage.save('../../dataset/train/mo/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   rotate_image_:
...
"""   
    def rotate_image_(self,angle,counter):
        ...
        for i in range (0,38):
            ...
            for rotate_train_mo in range (0,100):
                manipulated.save('../../dataset/train/mo/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   zoom_image:
...
""" 
    def zoom_image(self,counter): 
        ...
        for i in range (0,38):
            ...
            for zoom_train_mo in range (0,100):
                manipulated.save('../../dataset/train/mo/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
...
""" 
    def shear(self,counter):
        ...
        for i in range (0,38):
            ...
            plt.axis('off')
            for shear_train_mo in range (0,100):
                plt.imsave('../../dataset/train/mo/picture_'+str(counter) + '.png', sheared_img)
                counter = counter + 1
        return counter
    """
   transpose_90:
...
""" 
    def transpose_90(self,counter): 
        for i in range (0,38):
            ...
            for trans_train_mo in range (0,100):
                manipulated.save('../../dataset/train/mo/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
...
""" 
    def transpose_270(self,counter):
        for i in range (0,38):
            ...
            for tran_train_mo in range (0,100):
                manipulated.save('../../dataset/train/mo/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
