...
""" 
    def blur(self,blurr,counter): 
        ...
        for i in range (0,38):
            ...
            for blur_test_ka in range (0,5):
                gaussImage.save('../../dataset/test/ka/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   rotate_image_:
...
""" 
    def rotate_image_(self,angle,counter):
        ...
        for i in range (0,38):
            ...
            for rotate_test_ka in range (0,50):
                manipulated.save('../../dataset/test/ka/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
   zoom_image:
    ...
    def zoom_image(self,counter): 
        ...
        for i in range (0,38):
            ...
            for zoom_test_ka in range (0,50):
                manipulated.save('../../dataset/test/ka/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
...
""" 
    def shear(self,counter):
        for i in range (0,38):
            ...
            plt.axis('off')
            for shear_test_ka in range (0,50):
                plt.imsave('../../dataset/test/ka/picture_'+str(counter) + '.png', sheared_img)
                counter = counter + 1
        return counter
    """
   transpose_90:
...
""" 
    def transpose_90(self,counter): 
        for i in range (0,38):
            ...
            for trans_test_ka in range (0,50):
                manipulated.save('../../dataset/test/ka/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
    """
...
""" 
    def transpose_270(self,counter):
        for i in range (0,38):
            ...
            for tran_test_ka in range (0,50):
                manipulated.save('../../dataset/test/ka/picture_'+str(counter) + '.png')
                counter = counter + 1
        return counter
